...
class CodeWriter:
    ...
    def write_arithmetic(self, command: str):
        ...
        if command == "add":
            ...
            self._pop_d()
            # TODO: Can I optimize this without loops?
            # Maybe implement XOR logic to check if equals?
            self.buffer.append("  A=M-1\n")
    ...
    def _pop(self, segment: str, index: int):
        ...
        if segment == "local":
            ...
            self._store_d_ram(f"{self.file.name[:-4]}_{index}")
    ...
    def _push(self, segment: str, index: int):
        ...
        if segment == "local":
            ...
            self._load_ram_d(f"{self.file.name[:-4]}_{index}")
